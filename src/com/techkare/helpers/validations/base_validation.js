...
/**
 * @namespace com.techkare.helpers.validations
 ...
 * @extends com.techkare.helpers.base_helper
 * @classdesc Application Base Model
 * @memberof com.techkare.helpers.validations
 */
 ...
 * @see com.techkare.helpers.validations.base_validation
 */
...
module.exports.base_validation = class base_validation extends baseHelper {
   ...
   * @private
   * @memberof com.techkare.helpers.validations.base_validation
   * @function validate
  ...
  validate(data, rule) {
    return this.Joi.validate(data, rule, {
      abortEarly: false,
  ...
  validateCallback(data, rule, callback) {
    return this.Joi.validate(
      data,
      rule,
      { abortEarly: false, language: this._messages },
      callback
    );
  }
};
