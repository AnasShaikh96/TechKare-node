 ...
 * @memberof com.techkare.routes
 * @module base_routes
 * @see com.techkare.routes.base_routes
 */
...
module.exports.base_routes = class base_routes {
  constructor(app, name) {
    ...
    ContollerFile =
      ...
      "/" +
      "controllers" +
      ContollerFile.replace("routes", "controller");
    this.controller = new (require(ContollerFile)[
   ...
   * @public
   * @memberof com.techkare.routes.base_routes
